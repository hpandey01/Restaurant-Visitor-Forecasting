...
df_filtered = data[data['air_store_id'] == 'air_ba937bf13d40fb24']
df1 = df_filtered[['visitors','holiday_flg']]
df1.shape
...
a=np.array(df1['visitors'].tolist())
b=np.array(df1['holiday_flg'].tolist())
b=b.reshape(-1,1)
a=a.reshape(-1,1)
reg.fit(b,a)
...
train.to_csv("und1.csv",index=False,encoding='utf8')
data.to_csv("und2.csv",index=False,encoding='utf8')
